...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="maneshwar kurapati" />
          <h3 className="name">maneshwar kurapati</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>maneshwar kurapati</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>maneshwar kurapati </h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>winfield high school,khammam</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> manihkurapati.0018@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 7386788489 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> madhira</h3>
            </div>
          </div>
        </div>
      </section>
